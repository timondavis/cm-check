...
var ResultModifier_1 = require("../../lib/Check/Modifier/ResultModifier");
var D20AttributeCheck = /** @class */ (function (_super) {
    ...
    function D20AttributeCheck(attributeValue, target, attributeName) {
        ...
        _this.addModifier(new ResultModifier_1.ResultModifier(_this.attributeName, D20AttributeCheck.translateAttributeValue(attributeValue)));
        return _this;
    }
    /**
