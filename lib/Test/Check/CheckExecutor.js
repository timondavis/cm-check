...
describe('CheckExecutor', function () {
    ...
    it('should facilitate registration and generation of any registered modifier type', function () {
        CE.registerModifierType('MyTargetModifier', function () { return new MyTargetModifier('test', TestCore_1.TestCore.randomInt()); });
        ...
        CE.execute(c);
        chai_1.expect(c.getTarget()).to.be.equal(7);
    });
});
