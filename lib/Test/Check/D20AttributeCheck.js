...
describe('D20AttributeCheck', function () {
    ...
    it('should automatically convert attribute values into standard attribute modifiers according to D20 system', function () {
        c = new D20AttributeCheck_1.D20AttributeCheck(0, 10, 'Int');
        ...
        c = new D20AttributeCheck_1.D20AttributeCheck(19, 10, 'Int');
        chai_1.expect(Number(c.getModifiers()[0].getValue())).to.be.equal(3);
        c = new D20AttributeCheck_1.D20AttributeCheck(20, 10, 'Int');
        chai_1.expect(Number(c.getModifiers()[0].getValue())).to.be.equal(3);
        c = new D20AttributeCheck_1.D20AttributeCheck(21, 10, 'Int');
        chai_1.expect(Number(c.getModifiers()[0].getValue())).to.be.equal(3);
        c = new D20AttributeCheck_1.D20AttributeCheck(22, 10, 'Int');
        chai_1.expect(Number(c.getModifiers()[0].getValue())).to.be.equal(4);
        c = new D20AttributeCheck_1.D20AttributeCheck(30, 10, 'Int');
        chai_1.expect(Number(c.getModifiers()[0].getValue())).to.be.equal(6);
        c = new D20AttributeCheck_1.D20AttributeCheck(43, 10, 'Int');
        chai_1.expect(Number(c.getModifiers()[0].getValue())).to.be.equal(11);
        c = new D20AttributeCheck_1.D20AttributeCheck(45, 10, 'Int');
        chai_1.expect(Number(c.getModifiers()[0].getValue())).to.be.equal(11);
        c = new D20AttributeCheck_1.D20AttributeCheck(46, 10, 'Int');
