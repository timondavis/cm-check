...
describe('ResultModifier', function () {
    ...
    it('should be serializable and deserializable', function () {
        ...
        var m = new ResultModifier_1.ResultModifier('Name', value);
        var serializedM = ResultModifier_1.ResultModifier.serialize(m);
        var ok = new ResultModifier_1.ResultModifier();
        var deserializedM = ok.deserialize(serializedM);
        chai_1.expect(deserializedM.getType()).to.be.equal('result');
