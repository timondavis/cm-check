...
describe('TargetModifier', function () {
    ...
    it('should be serializable and deserializable', function () {
        ...
        var m = new TargetModifier_1.TargetModifier('Name', value);
        var serializedM = TargetModifier_1.TargetModifier.serialize(m);
        var ok = new TargetModifier_1.TargetModifier();
        var deserializedM = ok.deserialize(serializedM);
        chai_1.expect(deserializedM.getType()).to.be.equal('target');
