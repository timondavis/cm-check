...
var DieBag = /** @class */ (function () {
     ...
     * @param {number} sides
     */
    DieBag.prototype.add = function (count, sides) {
        if (!this.isDieIndexExists(sides)) {
            this.addNewDieIndex(sides);
        }
        for (var index = 0; index < count; index++) {
            this.dieMap[sides].push(new Die_1.Die(sides));
        }
    };
    /**
    ...
    DieBag.prototype.tabulateCollectionRoll = function () {
        var self = this;
        var total = 0;
