define(["require", "exports", "../../Die/Die", "chai", "chai", "mocha"], function (require, exports, Die_1, chai_1, chai_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    describe('Die', function () {
        var die = new Die_1.Die(20);
        it('should prevent invalid die from being created', function () {
            chai_2.expect(function () { return new Die_1.Die(0); }).to.throw;
            chai_2.expect(function () { return new Die_1.Die(-1); }).to.throw;
        });
